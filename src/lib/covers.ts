...
export type Cover = { id: string; position?: string };
...
export const COVERS: Record<string, Cover> = {
  ...
  realism: { id: 'met-436544', position: 'center 28%' }, // Tiburcio Pérez (Goya)
  ...
  japanese: { id: 'met-39799' }, // The Great Wave off Kanagawa
  armenian: { id: 'wikidata-Q1070896' }, // The Ninth Wave (Aivazovsky)
  asian: { id: 'cma-132837' }, // Album of Seasonal Landscapes
  portraits: { id: 'met-436532', position: 'center 22%' }, // Van Gogh, Self-Portrait with a Straw Hat
  landscapes: { id: 'met-436535' }, // Wheat Field with Cypresses
  sacred: { id: 'wikidata-Q128910' }, // The Last Supper
  sculpture: { id: 'wikidata-Q179900', position: 'center 10%' }, // David (Michelangelo)
  print: { id: 'wikidata-Q17227585', position: 'center 40%' }, // Kajikazawa in Kai province
  photography: { id: 'met-262612' }, // View on the Columbia, Cascades
};
